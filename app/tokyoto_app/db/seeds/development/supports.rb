  ...
  [
    {
      ...
      user_application_method: "申請を行う方により必要書類が異なるため、「子ども家庭部子ども家庭課育成支援係（区役所本庁舎2階16番窓口）」へ事前にご連絡をお願いします。交付申請をした日から助成の対象となります。公式HPを参照",
    ...
    },
    {
      ...
      user_application_method: "申請書を記入し、必要書類を添付して区に郵送していただくか、直接お持ちください。",
      user_application_limit: "",
      publish_state: 0,
    },
    {
      ...
      user_application_limit: "令和3年度の募集期間は、10月1日（金）から10月15日（金）",
      publish_state: 0,
    },
    {
      id: 4,
      ...
      user_application_method: "公式HP参照",
      user_application_limit: "",
      publish_state: 0,
    },
    {
      ...
      user_application_method: "新宿区立小・中学校へお子さんが通学されている方は、学校に申請書がありますので、ご記入の上、必要書類（詳細は申請書に記載しています。）を添付して学校へご提出ください。",
      user_application_limit: "なし",
      publish_state: 0,
    },
    {
      id: 6,
    ...
    {
      id: 7,
      support_name: "入園料金補助金（私立幼稚園)",
      content: "台東区では、私立幼稚園に入園した幼児の保護者に対し、入園料等の負担を軽減することで、幼児教育の振興を図るため、入園料等補助金を交付",
    ...
    {
      id: 19,
      support_name: "幼稚園の利用料 幼児教育・保育の無償化（私立幼稚園に関する概要) ",
      content: "幼児教育は生涯にわたる人格形成の基礎を培う重要なものであり、子育て世帯の経済的負担の軽減を図る少子化対策の観点などから、幼児期の教育及び保育施設の利用料の無償化を実施",
      user_application_method: "子育てのための施設等利用給付認定申請書（法第３０条の４第１号）を在籍する幼稚園に提出
https://www.city.taito.lg.jp/kosodatekyouiku/yochien/shiritsuyochien/mushouka1.files/1.pdf",
      user_application_limit: "記載なし",
      user_renewal_method: "記載なし",
      user_renewal_month: "記載なし",
      publish_state: 1,
