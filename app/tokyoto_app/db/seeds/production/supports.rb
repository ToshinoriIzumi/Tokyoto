...
Support.create!(
  [
    ...
    {
      id: 20,
      support_name: "私立幼稚園等保護者補助金",
      content: "区では、区内に住所を有し、私立幼稚園等に就園されている園児の保護者の方に、保護者補助金（所得制限あり）を交付しています。なお、私立幼稚園等のうち、子ども・子育て支援新制度に移行した園は本補助金の対象ではありません。",
      publish_state: 1,
    },

    {
      id: 21,
      support_name: "養育費受け取り支援事業補助金（公正証書作成等手数料補助）",
